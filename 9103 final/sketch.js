...
function preload() {
// Load audio file, must be in preload to ensure loading before setup
...
class RingPattern {
    ...
    // Add scale parameter, used to scale the whole ring and all its effects
    display(scale = 1) {
        noStroke();
        noFill();
        ...
        // Pass scale to drawing each region
